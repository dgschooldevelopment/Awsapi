...
app.use(bodyParser.json({ limit: '500mb' })); // Increase limit for JSON request body
app.use(bodyParser.urlencoded({ limit: '500mb', extended: true })); // Increase limit for URL-encoded request body
